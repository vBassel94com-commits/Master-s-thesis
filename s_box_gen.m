function [s_box, inv_s_box] = s_box_gen (vargin,II)
...
elseif II==1
    mod_pol = bin2dec ('110001011');
    elseif II==2
    mod_pol = bin2dec ('110001101');

    elseif II==3
    mod_pol = bin2dec ('110011111');

    elseif II==4
    mod_pol = bin2dec ('110110001');

    elseif II==5
    mod_pol = bin2dec ('111001111');
 elseif II==6
    mod_pol = bin2dec ('111010111');
     elseif II==7
    mod_pol = bin2dec ('111111001');
